...
export default function ThankYouPage({ onReturnHome, onViewStatue, quantity = 1 }: ThankYouPageProps) {
          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-0 border-b border-white/5 pb-6 mb-6 relative z-10">
              ...
              <div className="text-left md:text-right">
                ...
                <div className="inline-flex items-center gap-2 text-green-400 font-bold tracking-wider text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
              ...
              <div className="space-y-1">
                <div className="text-[9px] font-mono text-white/40 uppercase tracking-widest">Spedizione</div>
                <div className="text-gold text-xs font-bold uppercase tracking-wider animate-pulse">Prevista inizio Q4</div>
              </div>
            </div>
          </motion.div>
        </BatmanText>
        ...
        <BatmanText delay={2.2}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button
              ...
              className="relative px-8 py-4 bg-gold text-black font-black uppercase tracking-widest text-xs transition-all hover:bg-white hover:shadow-[0_0_30px_rgba(250,204,21,0.4)] group overflow-hidden"
            >
              <div className="absolute inset-0 w-0 bg-white transition-all duration-[250ms] ease-out group-hover:w-full z-0" />
            ...
            <button
              ...
              className="px-8 py-4 border border-white/20 text-white font-bold uppercase tracking-widest text-xs transition-all hover:border-white hover:bg-white/5"
            >
              Rivedi il Cavaliere
            </button>
          </div>
